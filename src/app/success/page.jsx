    ...
    <>
      <div className="flex flex-col pt-10 items-center h-screen bg-gray-100">
        <div className="max-w-lg bg-white p-8 rounded-lg shadow-md">
          ...
          <button style={{border:"1px solid black",display:"flex",justifyContent:"center",borderRadius:"5px",backgroundColor:"#fef08a",padding:"5px",margin:"0 auto",color:"black"}}><HomeButtonRedirection /> </button>
        </div>
      </div>
