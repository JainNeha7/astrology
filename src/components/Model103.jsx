...
function Model103() {
  ...
  const [formValues, setFormValues] = useState({
    productinfo: 'Ancestral blockage removal package',
    amount: '32,500',
    firstname: '',
    name: '',
    email: '',
  ...
  return (
    <>
      <div>
        <dialog id="my_modal_8" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">Ancestral blockage removal package</h3>
      ...
      <form id="paymentForm8" action="https://secure.payu.in/_payment" method="post" style={{ display: 'none' }}>
